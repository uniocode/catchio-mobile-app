...
const SignUpScreen = ({navigation}) => {
    return ( 
        <NonScrollContainer>
            ...
            <Button round={true}  title="Create Account" color={Colors.pastelCoral} width="80%" marginTop='10px'/>
            <TextWrapper>
                <SmallText marginTop='30px' color={Colors.mediumGray}>Or sign up with:</SmallText>
                <Button round={true} title="Google" color='#4c8bf5' width="80%" marginTop="20px"/>
                <Button round={true} title="Facebook" color='#3b5998'  width="80%" marginTop="10px"/>
            </TextWrapper>
            <TextWrapper marginTop='40px'>
